...
function OrderForm() {
  ...
  useEffect(() => {
    ...
    const experimentVariation = window.google_optimize.get(GoogleOptimizeId.experimentId);
  ...
  return (
    <div className='container'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        {variation === 1 ? (
         <Button type="submit" style={{ backgroundColor: "#008000" }} value="orderForm.submitButton" />
        ):(
